...
import { ionPersonCircleOutline, ionNewspaperOutline, ionSettingsOutline, ionLogOutOutline } from '@ng-icons/ionicons';
...
@NgModule({
    ...
    imports: [
        ...
        MatInputModule,
        ReactiveFormsModule,
        NgIconsModule.withIcons({ ionSearchOutline, ionMenuSharp, ionPersonCircleOutline, heroAcademicCap, ionNewspaperOutline, ionSettingsOutline, ionLogOutOutline })
    ],
    exports: [],
    providers: [],
    bootstrap: [],
