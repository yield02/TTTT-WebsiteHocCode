...
import { ChangeDetectionStrategy, Component, ComponentRef, ElementRef, Input, OnDestroy, OnInit, ViewChild } from '@angular/core';
...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  onSubmit(): void {
    ...
    this.subscriptions.push(this.authService.login(this.signInForm.value as { username: string, password: string }).subscribe(
      (res) => {
  ...
  loginGoogle() {
    this.subscriptions.push(this.authService.loginWithGoogle().subscribe());
  }
